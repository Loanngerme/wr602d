 ...
 */
final class Version20260209091451 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD lastname VARCHAR(255) DEFAULT NULL, ADD firstname VARCHAR(255) DEFAULT NULL, ADD dob DATE DEFAULT NULL, ADD photo VARCHAR(255) DEFAULT NULL, ADD favorite_color VARCHAR(7) DEFAULT NULL, ADD phone VARCHAR(20) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `user` DROP lastname, DROP firstname, DROP dob, DROP photo, DROP favorite_color, DROP phone');
    }
}
